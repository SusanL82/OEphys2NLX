...
function InFile = OEPhysSpikes2NTT(InPath,InFile,OutPath,wv_plot,spk_plot,Header)
%% load spike file
disp('loading spikes')
fn = [InPath,'/',InFile];
...
Mat2NlxSpike(NTTname, AppendToFileFlag, ExportMode, [], FieldSelectionFlags, timestamps, ScNumbers, CellNumbers, Features, data, Header)
